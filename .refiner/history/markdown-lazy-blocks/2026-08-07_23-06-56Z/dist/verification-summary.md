...
- `node scripts/check-markdown-lazy-chunks.mjs`: pass. It recursively traverses `imports`, rejects forbidden engine entries in the static closure, requires both dynamic entries, and verifies their emitted names.
