...
Define the responsive application shell, shared navigation model, command access, UAR brand projection, state boundary, and accessibility behavior for the React frontend.
