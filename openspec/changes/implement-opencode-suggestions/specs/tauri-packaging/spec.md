...
The system SHALL support executing MCP servers as Tauri sidecars when running in a bundled environment.
...
- **Then** the system MUST resolve the absolute path to the sidecar binary
...
- **Then** the system MUST execute the command as a standard system process.
