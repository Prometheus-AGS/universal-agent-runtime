...
artifact = root / '.refiner/artifacts/fix-skills-scope-semantics'
...
state schema PASS
referenced file PASS: .refiner/artifacts/fix-skills-scope-semantics/dist/verification-summary.md
...
```bash
crates/prometheus-skill-system/skills/imported/artifact-refiner/scripts/state-finalize.sh fix-skills-scope-semantics
```

Observed output, exit 0:

```text
.refiner/history/fix-skills-scope-semantics/2026-08-18_17-30-25Z
```

The post-finalization schema replay observed exit 0:
