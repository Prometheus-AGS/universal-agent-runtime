...
>
> **Final resolution (2026-08-08):** C-12 retained the upgraded round-trip tester
> as a development-only surface and removed it from production discovery while
> preserving live A2UI product behavior. The canonical implementation and
> verification are archived at
> `openspec/changes/archive/2026-08-08-chunk-catalog-renderers/`. This stale
> removal delta was never synced into `a2ui-testing-ui`.
