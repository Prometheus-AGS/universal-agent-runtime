...
>
> Final resolution: see
> `openspec/changes/archive/2026-08-08-chunk-catalog-renderers/`. The tester is
> retained for development and excluded from production discovery; these stale
> deletion tasks intentionally remain unchecked because they were not executed.
