...
- [x] 2.2 Preserve slot identity and authoritative reconnect configuration across upsert, filtered, and merged registry projections while keeping each view's server/tool policy maps independent; verify focused authorization and A→B stale-config rejection tests pass
