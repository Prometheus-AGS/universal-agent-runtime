## 1. Plan
- [x] 1.1 Per-screen validation matrix from the assessment's 20-screen inventory (purpose, function, evidence).
## 2. Suites
- [x] 2.1 BDD features for admin screens (skills lifecycle, knowledge, agents, memory, auth/JWT, settings, cost, runtime cockpit).
- [x] 2.2 Live chat validation: any-agent focus, orchestrator/default Q&A with expected answers, KB-hit rendering, memory levels, isolation (two users).
