## 1. Dependency and Deployment

- [x] 1.1 Pin `crates/prometheus-skill-system` to upstream commit `602750ec61bc4674b51231fb36f3bfee3af42b7e` and verify the gitlink resolves to the pushed review branch.
- [x] 1.2 Record the passing source, release, installed-CLI, signing, rollback, and unchanged-daemon evidence for issue #265.
