...
const isMarkdownEngineModule = (moduleId: string): boolean =>
  /[\\/]node_modules[\\/](?:mermaid|shiki|@shikijs[\\/]|@mermaid-js[\\/])/u.test(moduleId);

const packageRelativeModuleId = (moduleId: string): string => {
...
export const markdownEngineGraphPlugin = (): Plugin => ({
