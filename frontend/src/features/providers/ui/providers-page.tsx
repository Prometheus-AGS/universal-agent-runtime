...
import { AdminEmptyInline, AdminError, AdminSidebarSkeleton } from "@/shared/ui/configuration/configuration-states";
import { cn } from "@/lib/utils";
import { useProviderModels } from "../model/use-provider-models";
import { useProvidersAdmin } from "../model/use-providers-admin";
        ...
        <div className="flex gap-1 border-b border-border px-3 py-2">
          {(["all", "configured", "unconfigured"] as const).map((f) => (
            <button
              ...
              onClick={() => setFilter(f)}
              className={cn(
                "rounded px-2 py-0.5 font-mono text-xs transition-colors capitalize focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring",
