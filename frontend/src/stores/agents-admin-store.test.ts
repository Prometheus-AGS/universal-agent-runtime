...
vi.mock("@/services/knowledge-api", () => ({ fetchKnowledgeBases: vi.fn() }));
vi.mock("@/services/skills-api", () => ({ fetchSkillsList: vi.fn() }));
vi.mock("@/services/tools-api", () => ({ fetchToolsDiscovery: vi.fn() }));
