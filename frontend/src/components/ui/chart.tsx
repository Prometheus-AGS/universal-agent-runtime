...
// recharts doesn't re-export ValueType/NameType from its top-level index
// (only DefaultTooltipContentProps) — mirrored locally here, same as
// TooltipNameType above.
