...
> projection was refreshed from canonical revision 349 on 2026-08-23.

**Phase path**: `uar-branded-documentation-site`
**Stage**: Execute
**Changes**: 4/11 complete
**Next action**: `/opsx:new document-inference-skills-knowledge-and-agents`
