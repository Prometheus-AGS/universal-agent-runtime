...
export function validateDocumentationPublication({ root = defaultRoot, trackedPaths = null, builtOutput = null, runChildren = true } = {}) {
  ...
  const childResults = [];
  if (runChildren) {
    for (const script of ["scripts/validate-documentation-truth.mjs", "scripts/validate-documentation-architecture.mjs", "scripts/validate-documentation-history.mjs", "scripts/validate-documentation-testing-history.mjs", "scripts/validate-documentation-product-workflows.mjs", "scripts/validate-documentation-security-operations.mjs", "scripts/validate-documentation-developer-reference.mjs", "scripts/validate-documentation-readme-estate.mjs", "scripts/validate-github-actions-policy.mjs"]) {
