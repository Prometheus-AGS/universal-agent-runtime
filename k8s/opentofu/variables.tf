...
variable "surreal_image" {
  description = "Immutable SurrealDB 3.3.0 image reference"
  type        = string
  default     = "surrealdb/surrealdb:v3.3.0@sha256:681c6c22c287421b5c7d99e0fde79b6e0d32c36c1ddeaab2762a1661cb04cd20"
}
