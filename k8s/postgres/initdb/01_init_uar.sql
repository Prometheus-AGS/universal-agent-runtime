-- Base UAR schema: sessions, skills, knowledge_bases, knowledge_chunks.
-- pgvector extension is already enabled by 00_extensions.sql; the
-- CREATE EXTENSION IF NOT EXISTS below is kept for idempotency.
